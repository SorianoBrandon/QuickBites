...
class ManagerScreen extends StatelessWidget {
  ManagerScreen({super.key, required this.user});
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            ...
            EmpleadoListWidget(establecimiento: user["establecimiento"],),
...
class EmpleadoListWidget extends StatelessWidget {
  EmpleadoListWidget({Key? key, required this.establecimiento}) : super(key: key);
                          ...
                          try {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                ...
                                content: Text('Información actualizada y empleado agregado a la sucursal'),
                              ),
                            );
        ...
        subtitle: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Codigo: $codigo", style: const TextStyle(fontSize: 10, color: Colors.green)),
